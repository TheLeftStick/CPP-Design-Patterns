...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Enter Bid for Room";
			// 
			// textBox1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(39, 80);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(141, 44);
			this->button1->TabIndex = 2;
			this->button1->Text = L"Place Bid Request";
			...
			this->ClientSize = System::Drawing::Size(224, 169);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (textBox1->Text == String::Empty) {
			MessageBox::Show("Please fill in text box with a number!");
		}
		else {
			temp = Convert::ToDouble(textBox1->Text);
		}

		suite->handleRequest(temp);
	} // end button1
	};
}
